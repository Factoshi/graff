...
export const query: QueryResolvers = {
    ...
    currentMinute: async (root, args, { factomd }) => {
        ...
        return {
            ...
            currentBlockStartTime: currentMinute.currentblockstarttime.toString(),
            currentMinuteStartTime: currentMinute.currentminutestarttime.toString(),
            currentTime: currentMinute.currenttime.toString(),
